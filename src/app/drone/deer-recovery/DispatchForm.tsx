    ...
    return (
      <div className="max-w-xl rounded-xl border border-[#DC2626]/40 bg-[#DC2626]/5 p-8">
        ...
        <p className="text-sm text-gray-300 leading-relaxed mb-4">
          Keep your phone on. He will call the number you left. The $250 books the flight if he can take it tonight.
        </p>
      ...
      <div className="space-y-8">
        <div className="bg-white/[0.03] border border-white/5 rounded-xl p-6">
          ...
          <ol className="space-y-3 text-sm text-gray-400">
            ...
            <li className="flex gap-3"><span className="text-[#DC2626] font-bold font-mono">3</span>$250 books the flight if he can take it</li>
          </ol>
        </div>
        <div className="bg-white/[0.03] border border-white/5 rounded-xl p-6">
