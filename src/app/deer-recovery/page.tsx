...
export const metadata: Metadata = {
  ...
  description:
    "Shot a deer you cannot find? Thermal search in Northeast Ohio. $150 to come out. $100 more if we find it.",
};
      ...
      <section className="py-20 border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mb-8">
            Shot a deer you cannot find? Thermal search, Northeast Ohio. $150 to come out. $100 more if we find it.
          </p>
          <div className="flex flex-wrap gap-3 mb-8">
            {["Ohio only", "$150 to come out", "$100 more if found", "Thermal search"].map((b) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              { step: "02", title: "Pay the $150 deposit", desc: "That deposit books the flight. You pay $150 for the look, whether the deer is found or not." },
              { step: "03", title: "Dean flies if he can make it tonight", desc: "If he can take the job, he comes out and searches. $100 more if he finds it. $250 total if found." },
            ].map((s) => (
              <div key={s.step}>
      ...
      <section id="pricing" className="py-20 scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-gray-400">$150 search. $100 find. $250 if found. No season pack. Hunters pay when they just shot a deer and cannot find it.</p>
          </div>
          <div className="max-w-md">
            <div className="flex flex-col rounded-xl p-8 border border-[#DC2626]/40 bg-[#DC2626]/5">
              ...
              <div className="text-xs text-gray-500 mb-4">+ $100 if found ($250 total)</div>
              <p className="text-sm text-gray-400 mb-6">
                The $150 deposit is the search. You pay it no matter what. If Dean finds it, $100 more. No season pack.
              </p>
              <ul className="space-y-2.5 mb-8">
                {[
                  "$150 to come out and look",
                  "$100 more if he finds it",
                  "$250 total if found",
              ...
              <div className="rounded-lg border border-white/10 bg-black/20 p-4 mb-6">
                <div className="text-sm font-semibold mb-1">$150 deposit books the flight</div>
                <p className="text-xs text-gray-500 mb-4">
                  {depositUrl
                    ? "Pay the deposit to book the search. Dean still has to be able to make it tonight."
                    : "Payment link is not live yet. Submit the dispatch and Dean will tell you how to pay the $150 if he can take the job."}
                </p>
                <DepositButton
                  url={depositUrl}
